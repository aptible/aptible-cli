...
Commands:
  ...
  aptible logs_from_archive --bucket NAME | --aws-region REGION | --stack NAAME --decryption-keys ONE [TWO] [THREE] | --download-location | --string-matches ONE [TWO] [THREE] --bucket=BUCKET --decryption-keys=one two three --region=REGION --stack=STACK  # Retrieves logs from your S3 archive.
