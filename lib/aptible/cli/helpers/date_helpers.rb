module Aptible
  module CLI
    module Helpers
      module DateHelpers
        # This should only be used by the method processing timestamps from S3 file names S3LogHelpers
        # It is used to process a user-provided string into UTC.
        ...
        # This should only be used by the method processing timestamps from S3 file names S3LogHelpers
        # The file name does not include any time zone information, but we know it to be in UTC,
        # so we add the "Z"  
